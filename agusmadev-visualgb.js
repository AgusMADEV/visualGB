document.addEventListener("DOMContentLoaded", function () {
    class AgusmaEditor {
      ...
      initEditor() {
        ...
        container.classList.add("agusma-container");
        ...
        this.editorDiv.classList.add("agusma-editor");
      ...
      createBlockSelector(container) {
        ...
        blockSelector.classList.add("agusma-block-selector");
        ...
        addButton.classList.add("agusma-add-block");
      ...
      createHTMLToggle(container) {
        ...
        this.htmlEditor.classList.add("agusma-html-editor");
    ...
    if (newBlock) {
      ...
      newBlock.classList.add("agusma-block"); // Add this class to each block
    ...
    // Initialize the editor on every textarea with the class "agusma-lightslateblue".
    document.querySelectorAll("textarea.agusma-visualgb").forEach(textarea => {
      new AgusmaEditor(textarea);
    });
  });
